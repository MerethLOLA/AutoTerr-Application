...
class PermissionRoleSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            'manage_voitures' => ['type' => 'commercial', 'description' => 'Creer et modifier les vehicules'],
            'delete_voitures' => ['type' => 'commercial', 'description' => 'Supprimer un vehicule'],
            ...
            'manage_facturation' => ['type' => 'finance', 'description' => 'Générer et gérer les factures'],
