...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $roles = [
            ...
            ['key' => 'role_sales', 'name' => 'Commercial', 'description' => 'Ventes, locations, offres et gestion des prospects'],
            ['key' => 'role_commercial_manager', 'name' => 'Responsable Commercial', 'description' => 'Supervision des ventes, locations, assurances/conformité et de la flotte'],
