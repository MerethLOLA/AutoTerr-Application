  ...
  return (
    <div className="auth-shell" style={{ fontFamily: 'var(--font-sans)' }}>
      <div className="auth-nav">
        <Link href="/login/client" className="auth-back-btn">
      ...
      <div className="auth-card">
        <div style={{ textAlign: 'center', marginBottom: 22 }}>
          ...
          <p className="auth-subtitle">
            {sent ? 'Vérifiez votre boîte mail' : 'Entrez votre adresse e-mail'}
          </p>
        </div>
        ...
        {sent ? (
          <div>
            <p style={{ fontSize: 13, color: '#374151', lineHeight: 1.6, marginBottom: 18 }}>
              Si un compte client existe avec l&apos;adresse <strong>{email.trim()}</strong>, un e-mail contenant un lien de réinitialisation vient d&apos;être envoyé. Le lien expire dans 60 minutes.
            </p>
            <Link href="/login/client" className="auth-button" style={{ display: 'block', textAlign: 'center', textDecoration: 'none' }}>
