      ...
      <div className="w-full max-w-md">
        <div className="card p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-slate-900 dark:text-white">SunuPark Client</h1>
            <p className="text-slate-600 dark:text-slate-400 text-sm mt-2">Connectez-vous à votre compte client</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700 text-center">
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              Vous êtes employé ?{' '}
              <Link href="/login/employee" className="text-primary font-semibold hover:underline">
                Connectez-vous ici
              </Link>
            </p>
          </div>
