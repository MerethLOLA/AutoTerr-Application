    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
          ...
          <p className="mx-auto max-w-2xl text-base leading-7 text-white/75">
      ...
      <section className="py-16 bg-[#f9fbff]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            {/* Visual */}
            <div className="rounded-2xl p-8 text-center" style={{ background: LIGHT }}>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {VALEURS.map(({ icon, titre, texte }) => (
              <div key={titre} className="rounded-2xl border border-[#dbeafe] p-6 transition hover:shadow-md hover:border-[#185FA5]/30">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 grid-cols-2 sm:grid-cols-4">
            {EQUIPE.map(({ nom, poste, initiales, couleur }) => (
              <div key={nom} className="flex flex-col items-center text-center rounded-2xl border border-[#dbeafe] bg-white p-6 transition hover:shadow-md">
      ...
      <section className="py-16 text-center" style={{ background: `linear-gradient(135deg, ${NAVY}, #1d6fb8)` }}>
        <div className="mx-auto max-w-2xl px-4">
          <h2 className="text-3xl font-black text-white mb-4">Prêt à nous faire confiance ?</h2>
          <p className="text-white/70 text-sm mb-8">Rejoignez des centaines de clients qui nous font confiance pour leur mobilité au quotidien.</p>
