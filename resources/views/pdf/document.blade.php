...
.doc-eyebrow { font-size: 8px; font-weight: 700; text-transform: uppercase;
               letter-spacing: .18em; color: #9baab8; margin-bottom: 4px; }
...
<div class="header">
  ...
  <div class="h-right">
    ...
    <div class="ref-box">
      ...
      <div class="val">{{ $reference ?? ('DOC-'.now()->format('Ymd-His')) }}</div>
    </div>
    <div class="doc-meta">
...
{{-- ── DÉTAILS DU DOCUMENT ──────────────────────────────────────── --}}
<div class="section-lbl">Détails</div>
<table class="info">
  <tbody>
...
<div class="conditions">
  ...
  Ce document est émis par {{ $entreprise['nom'] }} et fait foi entre les parties.
