...
class VoitureController extends Controller
{
    public function publicIndex(Request $request)
    {
        ...
        $paginator = Voiture::query()
            ->select(['id', 'marque', 'modele', 'annee', 'prix', 'prix_vente', 'kilometrage', 'statut', 'type_usage', 'energie', 'puissance', 'cylindree', 'type_boite', 'transmission', 'nombre_portes', 'nombre_places', 'consommation', 'emissions_co2', 'image_principale', 'likes_count', 'created_at'])
